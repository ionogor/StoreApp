        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserOrder_Orders_UserId",
                        column: x => x.UserId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOrder_Users_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "laptop.jpg", "Laptop" });

            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "Id", "AdressId", "Email", "HomePage", "Name", "Phone" },
                values: new object[,]
                {
                    { 1, null, "test@test.com", "www.domain.com", "Dell", "+20952553434" },
                    { 2, null, "office@apple.com", "www.apple.com", "Apple", "+145423434543" },
                    { 3, null, "office@acer.com", "www.acer.com", "Acer", "+34354655654" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CatalogId", "Description", "Price", "Stock", "SupplierId", "Title" },
                values: new object[] { 1, 1, "Laptop Acer 15.6, 256Gb, 8Gb ", 900m, 0, 3, "Acer Laptop 755" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CatalogId", "Description", "Price", "Stock", "SupplierId", "Title" },
                values: new object[] { 2, 1, "Laptop Acer 13, 256Gb, 8Gb ", 1200m, 0, 2, "Apple Laptop MacbookPro" });
